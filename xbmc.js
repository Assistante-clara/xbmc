...
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('â', 'ig'),"a")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('à', 'ig'),"a")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('é', 'ig'),"e")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('è', 'ig'),"e")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('â', 'ig'),"a")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('-', 'ig')," ")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('-', 'ig')," ")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('ème', 'ig'),"e")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('eme', 'ig'),"e")
ClaraIA.reco=ClaraIA.reco.replace(new RegExp('  ', 'ig')," ")
...
if(data.valuexbmc=="playfilm"){
	...
	var temp1 = ClaraIA.reco.match(rgxp) ; var temp1=temp1[1].trim();console.log("on cherche :*"+temp1+'*')
...
listefilmxbmc.push(tempmov);listefilmxbmc.push(v['movieid'])
	...
	console.log(listefilmxbmc,"eeeeeeeeee",ClaraIA.reco);work()
});
